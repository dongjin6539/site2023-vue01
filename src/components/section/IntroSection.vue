...
export default {
  ...
  data: function () {
    return {
      title: "농구 입문<br />전문과정",
      desc: "농구를 시작하는 전문 과정입니다.<br />처음 시작하는 분들에게 필요합니다.",
      texts: [
        {
          title: "기본 기술",
          desc: "농구를 잘하기 위해서는 기본적인 농구 기술을 익히는 것이 중요합니다. 드리블, 패스, 샷, 리바운드 등의 기본 기술들을 연습하고 개선해야합니다. 또한 바른 자세와 테크닉을 익히는 것도 중요합니다.",
        },
        {
          title: "체력과 유연성",
